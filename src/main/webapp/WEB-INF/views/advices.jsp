		...
		'afterLoad': function(data){ // after loading content, you can use this function to animate your new elements
			$.each(data, function(i, n){
         		if(divnum != 0){
         			...
         			$('#div'+divnum).html('<h4>主题</h4>:'+n.title+'  内容:'+n.advice+'---'+n.userName);
         		}else{
         			$('#div'+divnum).html('<h4><span class="glyphicon glyphicon-leaf" aria-hidden="true"></span>'+n.title+'</h4><span><span class="glyphicon glyphicon-book" aria-hidden="true"></span>'+n.advice+'---'+n.userName+'</span>');
         		}
         		divnum++;
        	});
			 $('#content').append(data); 
