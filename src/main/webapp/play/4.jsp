...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/tree/style.css" type="text/css" media="screen, projection" />

<script type="text/javascript" src="<%=request.getContextPath()%>/resources/tree/verlet-1.0.0.js"></script>
